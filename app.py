...
# Descargar modelo y scaler si no están
...
def generate_feedback():
    ...
    try:
        ...
        prompt = f"""
Eres un pedagogo especializado en estilos de aprendizaje. 
Su estilo de aprendizaje es "{learning_style}".
...
Por favor dale estrategias, técnicas, recursos, aplicaciones y consejos prácticos
organizados en secciones numeradas y claras.
"""
